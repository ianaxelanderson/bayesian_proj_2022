...
finalres <- read_csv(here('Final Scraper Data', 'finalres2.csv'))
scrape <- read_csv(here('Final Scraper Data', 'Scrape1.csv'))
...
Does the impact of rewards (in the form of likes) on tweet frequency decrease as habit strength increases?
...
The plots below suggest satisfactory convergence.
...
Based on the results, we do not see an interaction effect between reward and habit strength in predicting tweet frequency.